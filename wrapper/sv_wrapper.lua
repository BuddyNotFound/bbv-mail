...
--     print( Config.Settings.Framework)
...
RegisterNetEvent('Wrapper:Inventory:Stash:Ox',function(id,label,weight,slots)
    src = source
    _id = id
    _label = label
    _weight = weight
    _slots = slots
    exports['ox_inventory']:RegisterStash(_id, label, _slots, _weight)
end)

RegisterNetEvent('Wrapper:Inventory:Stash:Ox:Open',function(label)
    local src = source 
    local l = label
    TriggerClientEvent('ox_inventory:openInventory', src, 'stash', label)
end)